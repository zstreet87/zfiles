...
```bash
measure note --tag arch --source rocminfo.txt:12 "MI355X reports gfx950"
```
...
command could have produced the fact — `measure run --tag arch -- rocminfo`
beats a note about rocminfo.
